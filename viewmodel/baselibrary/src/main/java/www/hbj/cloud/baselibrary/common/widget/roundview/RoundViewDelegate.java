...
public class RoundViewDelegate {
    ...
    private void obtainAttributes(Context context, AttributeSet attrs) {
        ...
        backgroundGradientStartColor = ta.getColor(R.styleable.RoundTextView_rv_backgroundGradientStartColor, Integer.MAX_VALUE);
        backgroundGradientEndColor = ta.getColor(R.styleable.RoundTextView_rv_backgroundGradientEndColor, Integer.MAX_VALUE);
    ...
    public void setBackgroundGradientStartColor(int backgroundGradientStartColor, int backgroundGradientEndColor) {
        this.backgroundGradientStartColor = ContextCompat.getColor(context, backgroundGradientStartColor);
        this.backgroundGradientEndColor = ContextCompat.getColor(context, backgroundGradientEndColor);
        setBgSelector();
    }
    ...
    public void setBgSelector() {
        ...
        if (backgroundGradientStartColor != Integer.MAX_VALUE && backgroundGradientEndColor != Integer.MAX_VALUE) {
            int[] colors = {backgroundGradientStartColor, backgroundGradientEndColor};
            GradientDrawable g = new GradientDrawable(GradientDrawable.Orientation.LEFT_RIGHT, colors);
            setDrawable(g, Integer.MAX_VALUE, strokeColor);
            ...
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP && isRippleEnable) {
                ...
                if (backgroundSelectedColor != Integer.MAX_VALUE) {
                    setDrawable(gd_background_selected, backgroundSelectedColor,
                            strokePressColor == Integer.MAX_VALUE ? strokeColor : strokePressColor);
                    bg.addState(new int[]{-android.R.attr.state_selected}, gd_background);
...
//              Log.d("AAA", textColors.getColorForState(new int[]{-android.R.attr.state_pressed}, -1) + "");
                ...
                if (textSelectedColor != Integer.MAX_VALUE) {
                    ColorStateList textColors = ((TextView) view).getTextColors();
//              Log.d("AAA", textColors.getColorForState(new int[]{-android.R.attr.state_pressed}, -1) + "");
                    ColorStateList colorStateList = new ColorStateList(

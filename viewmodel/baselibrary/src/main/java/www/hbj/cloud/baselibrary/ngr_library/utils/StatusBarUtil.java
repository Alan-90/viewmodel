...
/**
 * Created by zhengji on 2016/4/8.
 */
public class StatusBarUtil {
    ...
    public static void setColor(Activity activity, int color, int statusBarAlpha) {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
            ...
            activity.getWindow().setStatusBarColor(color);//calculateStatusColor(color, statusBarAlpha)
    ...
    public static void setCustomerColor(Activity activity, int color) {
        if (isFullScreen(activity)) {
            //如果定义了全屏
            return;
        }
...
//TODO
    ...
    public static void setStatusBarDarkMode(Activity activity) {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.KITKAT) {
            if (setMIUIStatusBarLightMode(activity.getWindow(), false)) {
//TODO
    ...
    public static void changeStatusBarTextColor(Activity activity, boolean isBlack) {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
            if (isBlack) {
                ...
                setColor(activity, activity.getResources().getColor(R.color.white));
            } else {
                //恢复状态栏白色字体
                activity.getWindow().getDecorView().setSystemUiVisibility(View.SYSTEM_UI_FLAG_VISIBLE);
                setColor(activity, activity.getResources().getColor(R.color.ngr_statusbarColor));
            }
        }

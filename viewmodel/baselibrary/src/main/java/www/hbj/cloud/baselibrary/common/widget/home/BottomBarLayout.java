...
public class BottomBarLayout  extends LinearLayout {
    ...
    public BottomBarLayout(Context context, AttributeSet attrs) {
        ...
        mSelector = typedArray.getDrawable(R.styleable.SegmentBar_sb_selected);
        mUnselector = typedArray.getDrawable(R.styleable.SegmentBar_sb_unselected);
        mDivider = typedArray.getDrawable(R.styleable.SegmentBar_sb_dividerDrawable);
        int dividerWidth = mDivider == null ? 0 : mDivider.getIntrinsicWidth();
        int dividerHeight = mDivider == null ? 0 : mDivider.getIntrinsicHeight();
        mDividerWidth = typedArray.getDimensionPixelSize(R.styleable.SegmentBar_sb_dividerWidth, dividerWidth);
        mDividerHeight = typedArray.getDimensionPixelSize(R.styleable.SegmentBar_sb_dividerHeight, dividerHeight);
        mDividerPadding = typedArray.getDimensionPixelSize(R.styleable.SegmentBar_sb_dividerPadding, 0);
        typedArray.recycle();
    }

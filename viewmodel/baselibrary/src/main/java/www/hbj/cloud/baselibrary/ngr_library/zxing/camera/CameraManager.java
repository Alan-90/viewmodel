...
package www.hbj.cloud.baselibrary.ngr_library.zxing.camera;
...
import www.hbj.cloud.baselibrary.ngr_library.zxing.camera.open.OpenCamera;
import www.hbj.cloud.baselibrary.ngr_library.zxing.camera.open.OpenCameraInterface;
...
//      rect.bottom = rect.bottom * cameraResolution.y / screenResolution.y;
    ...
    public void openLight() {
        if (camera != null) {
            parameter = camera.getCamera().getParameters();
